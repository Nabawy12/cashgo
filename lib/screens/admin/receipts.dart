                                                              ...
                                                              children: [
                                                                ...
                                                                ...returnsById
                                                                  ...
                                                                  final rows =
                                                                      entry
                                                                          .value;
                                                                  final meta = (saleReturnsCache[saleId] ?? []).firstWhere(
                                                                      (rm) =>
                                                                          (rm['id']
                                                                              as int?) ==
                                                                          rid,
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(':قبل الإجراء', style: TextStyle(fontWeight: FontWeight.bold, color: AppColorsDark.mainTextDark)),
                                                                              const SizedBox(height: 10),
                                                                              Text(
                                                                              ...
                                                                              const SizedBox(height: 10),
                                                                              Text('المشتري دفع: ${originalPaidBefore.toStringAsFixed(2)}', textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold, color: AppColorsDark.mainTextDark)),
                                                                              const SizedBox(height: 10),
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.end,
                                                                            children: [
                                                                              Text(':بعد الإجراء', style: TextStyle(fontWeight: FontWeight.bold, color: AppColorsDark.mainTextDark)),
                                                                              const SizedBox(height: 10),
                                                                              Text('إجمالي الفاتورة الآن: ${effectiveTotal.toStringAsFixed(2)}', textAlign: TextAlign.right, style: TextStyle(color: AppColorsDark.mainTextDark)),
                                                                              const SizedBox(height: 10),
                                                                              Builder(builder: (_) {
                                                                                if (paidDifference > 0) {
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Builder(builder:
                                                                          ...
                                                                          if (paidDeltaSum >
                                                                              0) {
                                                                            return Text('أثناء الاستبدال/المرتجع، دفع المشتري مبلغًا إضافيًّا قدره ${paidDeltaSum.toStringAsFixed(2)} (الكاشير استلم هذا المبلغ).',
                                                                                textAlign: TextAlign.right,
                                                                            ...
                                                                            return Text('خلال العملية لم يحدث أي دفع/استلام نقدي إضافي',
                                                                                textAlign: TextAlign.right,
